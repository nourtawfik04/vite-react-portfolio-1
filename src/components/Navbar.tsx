  ...
  return (
    <nav className="fixed top-0 left-0 right-0 py-8 px-6 bg-[#FFC700] dark:bg-neutral-900 items-center w-full z-50">
      <div className="flex justify-between items-center w-full">
        <button onClick={toggleMenu} className="focus:outline-none ml-auto mr-14 mt-5">
      ...
      >
        ...
        <Link to="/" className="text-sm text-neutral-800 dark:text-neutral-100">
          <h2 className="font-semibold">Menu</h2>
          </Link>
          <Link to="/" className="text-sm text-neutral-800 dark:text-neutral-100">
            About
          </Link>
          <Link to="/portfolio" className="text-sm text-neutral-800 dark:text-neutral-100">
            Portfolio
          </Link>
          <Link to="/resume" className="text-sm text-neutral-800 dark:text-neutral-100">
            Resume
          </Link>
        </div>
        ...
        <div className="flex flex-col space-y-4 mr-10">
          <h2 className="font-semibold">Coding Projects</h2>
          <Link to="/" className="text-sm text-neutral-800 dark:text-neutral-100">
            Tubender
          </Link>
          <Link to="/portfolio" className="text-sm text-neutral-800 dark:text-neutral-100">
        ...
        <div className="flex flex-col space-y-2 mr-30 ml-20">
          <button onClick={toggleMenu} className="focus:outline-none ml-auto mr-10">
            <img src="/images/collapse.png" alt="menu icon" className="w-8 h-8" />
          </button>
        </div>
      </div>
    </nav>
